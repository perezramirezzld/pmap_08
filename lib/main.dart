...
import 'package:flutter_pmap08/api_service.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> processData() async =>
      myGeoJson.parseGeoJsonAsString(apiGeoJson);
  @override
  void initState() {
    _getData().then((_) {
  ...
  Future<void> _getData() async {
    apiGeoJson = (await ApiService().getUsers());
    ...
    return Scaffold(
        ...
        body: FlutterMap(
          ...
          options: MapOptions(
            ...
            // zoom: 14,
            center:
                LatLng(21.12413566328141, -101.6859289619005), //León Guanajuato
            zoom: 2.0,
          ),
          children: [
            TileLayer(
